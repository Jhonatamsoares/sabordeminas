...
import com.example.cafeteria.exception.CommentAlreadyExistException;
import com.example.cafeteria.exception.OrderAlreadyCheckoutException;
import com.example.cafeteria.exception.OrderAlreadyDeliverException;
import com.example.cafeteria.exception.OrderNotExistException;
...
public class OrderController {
    ...
    public int addOrderToCart(@RequestBody String jsonOrder) {
        ...
        String adminId = order.getString("adminId");
        ...
        return orderService.addOrderToCart(customerId, adminId, list);
    }
